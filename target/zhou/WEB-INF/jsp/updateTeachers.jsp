...
<div class="container">
    ...
    <div class="example">
        <table id="editing-example" class="table" data-paging="true" data-filtering="true" data-sorting="true">
            <thead>
            <tr>
                <th data-name="Tid" data-breakpoints="xs" >Tid</th>
                <th data-name="Tname">Tname</th>
            ...
            <div class="modal-dialog" role="document">
                <form class="modal-content form-horizontal" id="editor">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group required">
                            <label for="Tname" class="col-sm-3 control-label">Tname</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="Tname" name="Tname" placeholder="Tname" required>
                            </div>
                        </div>
...
<script>
    jQuery(function($){
            ...
            ft = FooTable.init('#editing-example', {
                editing: {
                    ...
                    editRow: function(row){
                        ...
                        $editor.find('#Tname').val(values.Tname);
                        $editor.find('#Sex').val(values.Sex);
                        $editor.find('#Did').val(values.Did);
                        $modal.data('row', row);
                        $editorTitle.text('Edit row #' + values.Tid);
                        $modal.modal('show');
                    },
                    deleteRow: function(row){
                        ...
                        $.ajax({
                            type:'POST',
                            url: '/Teachers/delete',
                            data : {"table":"Teachers","Tid":values.Tid},
                            dataType:'json',
        ...
        $editor.on('submit', function(e){
            ...
            $.ajax({
                type:'POST',
                url: '/Teachers/updateoradd',
                data : {"table":"Teachers","Tid":values.Tid,"Tname":values.Tname,"Sex":values.Sex,"Did":values.Did},
                dataType:'json',
                success:function (data) {
                    var s = new String(data);
                    if(s == "true"){
