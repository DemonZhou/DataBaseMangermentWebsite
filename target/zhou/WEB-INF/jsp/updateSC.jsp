...
<div class="container">
    ...
    <div class="example">
        <table id="editing-example" class="table" data-paging="true" data-filtering="true" data-sorting="true">
            <thead>
            <tr>
                <th data-name="Scid" data-breakpoints="xs" data-type="number">id</th>
        ...
        <div class="modal fade" id="editor-modal" tabindex="-1" role="dialog" aria-labelledby="editor-title">
            ...
            <div class="modal-dialog" role="document">
                <form class="modal-content form-horizontal" id="editor">
                    ...
                    <div class="modal-body requried">
                        <input type="number" id="id" name="id" class="hidden"/>
                        <div class="form-group">
                            <label for="Scid" class="col-sm-3 control-label">Scid</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="Scid" name="Scid" placeholder="id" >
                            </div>
                        </div>
    ...
    jQuery(function($){
            ...
            ft = FooTable.init('#editing-example', {
                editing: {
                    ...
                    editRow: function(row){
                        var values = row.val();
                        $editor.find('#Scid').val(values.Scid);
                        $editor.find('#Sid').val(values.Sid);
                        $editor.find('#Cid').val(values.Cid);
                        $modal.data('row', row);
                        $editorTitle.text('Edit row #' + values.Scid);
                        $modal.modal('show');
                    },
        ...
        $editor.on('submit', function(e){
            ...
            $.ajax({
                type:'POST',
                url: '/SC/updateoradd',
                data : {"table":"SC","id":values.Scid,"Sid":values.Sid,"Cid":values.Cid},
                dataType:'json',
                success:function (data) {
                    var s = new String(data);
                    if(s == "true"){
