...
<div class="container">
    ...
    <div class="example">
        <table id="editing-example" class="table" data-paging="true" data-filtering="true" data-sorting="true">
            <thead>
            <tr>
                <th data-name="Mid" data-breakpoints="xs">Mid</th>
                <th data-name="Mname">Mname</th>
            ...
            <div class="modal-dialog" role="document">
                <form class="modal-content form-horizontal" id="editor">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group required">
                            <label for="Mname" class="col-sm-3 control-label">Mname</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="Mname" name="Mname" placeholder="Mname" required>
                            </div>
                        </div>
...
<script>
    jQuery(function($){
            ...
            ft = FooTable.init('#editing-example', {
                editing: {
                    ...
                    editRow: function(row){
                        ...
                        $editor.find('#Mname').val(values.Mname);
                        $editor.find('#Did').val(values.Did);
                        $modal.data('row', row);
                        $editorTitle.text('Edit row #' + values.Mid);
                        $modal.modal('show');
                    },
                    deleteRow: function(row){
                        ...
                        $.ajax({
                            type:'POST',
                            url: '/Majors/delete',
                            data : {"table":"Majors","Mid":values.Mid},
                            dataType:'json',
        ...
        $editor.on('submit', function(e){
            ...
            $.ajax({
                type:'POST',
                url: '/Majors/updateoradd',
                data : {"table":"Majors","Mid":values.Mid,"Mname":values.Mname,"Did":values.Did},
                dataType:'json',
                success:function (data) {
                    var s = new String(data);
                    if(s == "true"){
